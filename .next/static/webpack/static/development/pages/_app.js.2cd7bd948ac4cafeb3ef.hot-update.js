...
function signUpAPI() {
  console.log('signUpAPI'); // return axios.post('login');
}
...
function userSagar() {
  return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function userSagar$(_context5) {
    while (1) {
      switch (_context5.prev = _context5.next) {
        case 0:
          _context5.next = 2;
          return Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_1__["all"])([Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_1__["fork"])(watchLogin) // fork(watchSignUp),
          ]);
...
//# sourceMappingURL=_app.js.2cd7bd948ac4cafeb3ef.hot-update.js.map